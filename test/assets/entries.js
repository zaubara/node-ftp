...
const timezoneDiff = ((-new Date().getTimezoneOffset() / 60) * 3600000);
const resolveDate = date => new Date(new Date(date) - timezoneDiff);
...
const entires = [
  ...
  },
  {
    ...
    expected: {
      ...
      name: 'Test',
      size: 0,
      date: new Date('2018-08-22T12:05:00.000Z'),
    },
  ...
  },
  {
    ...
    expected: {
      ...
      name: '1400',
      size: 0,
      date: new Date('2013-07-10T04:54:00.000Z'),
    },
  ...
  },
  {
    ...
    expected: {
      ...
      name: 'iisstart.png',
      size: 99710,
      date: new Date('2018-08-22T10:59:00.000Z'),
    },
